...
import { ClipboardPaste, Copy, LayoutGrid, Play, Plus, Redo2, Trash2, Undo2 } from 'lucide-vue-next'
defineProps<{ running?: boolean; canUndo?: boolean; canRedo?: boolean; hasSelection?: boolean; canCopy?: boolean; canPaste?: boolean }>()
defineEmits<{ addShot: []; generate: []; deleteSelection: []; copy: []; paste: []; undo: []; redo: []; autoArrange: [] }>()
</script>
<template>
