...
.workbench-audio-media__identity img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}
...
.workbench-audio-media__range:focus-visible {
  outline: 2px solid #a88cf4;
  outline-offset: 2px;
}
...
.workbench-audio-media__play:hover {
  color: #110f10 !important;
  background: #c2adfa;
  transform: translateY(-1px);
}

.workbench-audio-media__play :deep(svg) {
  margin-left: 1px;
}

.workbench-audio-media__body {
  display: grid;
  min-width: 0;
  gap: 8px;
}

.workbench-audio-media__heading {
  display: flex;
  min-width: 0;
  align-items: center;
...
.workbench-audio-media__heading > span {
  display: flex;
  min-width: 0;
...
.workbench-audio-media__heading strong {
  overflow: hidden;
  font-size: 11px;
  font-weight: 600;
...
.workbench-audio-media__heading small {
  flex: none;
  color: #887f77;
  font-size: 9px;
}

.workbench-audio-media__heading time {
  flex: none;
  color: #aaa198;
  font-size: 9px;
...
.workbench-audio-media__volume:hover {
