...
describe('shot workbench configuration', () => {
  ...
  it('adapts saved settings to backend model capabilities', () => {
    ...
    expect(shotGenerationOptions(config, {
      ...
      reference_image_formats: ['jpg', 'jpeg', 'png', 'webp'],
      reference_video_formats: ['mp4', 'mov'],
      reference_video_codecs: ['h264', 'hevc'],
      reference_video_audio_codecs: ['aac', 'mp3'],
      reference_video_resolutions: ['480p', '720p', '1080p', '4k'],
      reference_image_max_size_mb: 30,
      reference_video_max_size_mb: 200,
      reference_media_duration_min: 2,
      reference_media_ratio_min: 0.4,
      reference_media_ratio_max: 2.5,
      reference_media_side_min: 300,
      reference_media_side_max: 6000,
      reference_video_pixels_min: 409600,
      reference_video_pixels_max: 8295044,
      reference_video_fps_min: 24,
