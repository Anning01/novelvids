...
function addVideoComposer() {
  const created = store.addVideoComposer(visibleNodePosition({ width: 390, height: 420 }))
  void ensureNodeVisible(created.key)
}
