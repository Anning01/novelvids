...
<style scoped>
.image-annotation{position:fixed;inset:0;z-index:2200;display:grid;padding:24px;place-items:center;background:rgb(12 12 14 / 82%);backdrop-filter:blur(8px)}
.image-annotation__panel{display:grid;width:min(1760px,96vw);height:min(94vh,1180px);grid-template-rows:auto auto minmax(0,1fr) auto auto;overflow:hidden;border:1px solid #514d47;border-radius:18px;color:#ece9e5;background:#211e1b;box-shadow:0 32px 90px rgb(0 0 0 / 48%)}
.image-annotation__panel>header,.image-annotation__panel>footer{display:flex;align-items:center;justify-content:space-between;padding:16px 20px}.image-annotation__panel>header{border-bottom:1px solid #49443e;font-size:16px}.image-annotation button{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:34px;padding:0 10px;border:1px solid #5b554e;border-radius:9px;color:inherit;background:#292622;cursor:pointer}.image-annotation button:hover:not(:disabled),.image-annotation button.is-active{border-color:#9a7aee;background:#403450}.image-annotation button:disabled{opacity:.38;cursor:not-allowed}
.image-annotation__toolbar{display:flex;align-items:center;gap:7px;overflow-x:auto;padding:10px 16px;border-bottom:1px solid #49443e;scrollbar-width:none}.image-annotation__toolbar::-webkit-scrollbar{display:none}.image-annotation__toolbar label{display:flex;align-items:center;gap:8px;min-height:34px;padding:0 10px;border:1px solid #5b554e;border-radius:9px;white-space:nowrap}.image-annotation__toolbar input[type=range]{width:100px;accent-color:#9a7aee}.image-annotation__color input{width:34px;height:25px;padding:0;border:0;background:none}.image-annotation__zoom{display:flex;align-items:center;border:1px solid #5b554e;border-radius:9px}.image-annotation__zoom button{border:0}.image-annotation__zoom output{min-width:52px;text-align:center}.image-annotation__undo{transform:scaleX(-1)}
.image-annotation__stage{position:relative;min-height:320px;overflow:auto;padding:14px;background:#0d0d0e;scrollbar-width:none}.image-annotation__stage::-webkit-scrollbar{display:none}.image-annotation__viewport{display:grid;place-items:center}.image-annotation canvas{display:block;max-width:none;touch-action:none;cursor:crosshair}.image-annotation canvas.is-move{cursor:move}.image-annotation__stage>span{position:absolute;inset:0;display:grid;place-items:center;background:rgb(13 13 14 / 70%)}
.image-annotation__panel>p{margin:0;padding:8px 20px;color:#ff9aa7;background:#40262b;font-size:12px}.image-annotation__panel>footer{border-top:1px solid #49443e;color:#aaa39b}.image-annotation__panel>footer button{border-color:#7e63dc;color:#fff;background:#6650c5}.image-annotation__panel>footer small{font-size:11px}
