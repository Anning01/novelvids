...
# 支持的平台列表（仅支持 vidu 和 doubao）
SUPPORTED_VIDEO_PLATFORMS = ["vidu", "doubao"]

# 用于生成视频提示词的平台模板
# {asset_refs} 会被替换为资产引用，格式：{ref:asset_id}
# vidu 客户端会将 {ref:id} 转换为 @id
# doubao 客户端会将 {ref:id} 转换为 [图N]
PLATFORM_PROMPT_TEMPLATES = {
    "vidu": """{asset_refs}{shot_size} shot, {camera_movement}.
{subject_description} {action}.
Environment: {location}, {time_of_day}, {lighting}.
Style: {video_style}, {mood}.
No text, no watermark, no logo.""",
    "doubao": """{asset_refs}{shot_size} shot, {camera_movement}.
{subject_description} {action}.
Environment: {location}, {time_of_day}, {lighting}.
Style: {video_style}, {mood}.
No text, no watermark, no logo.""",
